 ...
 * has an error.  Just because the tester is reporting that you failed the result
 * of a particular method (i.e. get) doesn't mean the problemis in the get method.
 *
 */
public class a1tester
{
	...
	/** 
	 * Displays a pass or fail for the current test.
	 * There is some magic going on here getting the line number 
	 * Borrowed from:
	 * http://blog.taragana.com/index.php/archive/core-java-how-to-get-java-source-code-line-number-file-name-in-code/
	 *
	 * Once we've discussed Exceptions in more detail this won't be required.		 
	 * @param passed If True, then a success message is printed,
	 *		if false, then a failure message is printed and the program is stopped.
	 */
	 ...
	 * specifically the constructor, size, add, get and find methods.
	 */
	...
	/**
 	 * Tests the PlayerList class,
 	 * specifically the get, find and remove methods.
	 */
	public static void PlayerListTestTwo() {
		System.out.println("PlayerList testing: size, equals, remove");
	...
	/**
 	 * Tests the ability of the PlayerList to expand.
	 */
	...
	/**
	 * Testing the expansion and tolerance of the PlayerList.
	 */
	public static void PlayerListStressTest() {
		...
		for (int i = (stressTestSize - 1); i > 0; i--){
			...
			if (l.find(p) != -1){
				//System.out.println(l.find(p) + "This is the size");
				passed = false;
				break;
			}
	...
	/**
	 * Runs the whole tester.
	 * @param args Command line extras, not used.
	 */
