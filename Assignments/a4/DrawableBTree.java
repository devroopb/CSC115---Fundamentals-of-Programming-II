 ...
 * datatype called a PatientRecord.
...
public class DrawableBTree extends JPanel{
	...
	private class DrawableBTNode extends Rectangle {
		 ...
		 * of the Node.
		 */
		DrawableBTNode(PatientMedRecord element, DrawableBTNode left, DrawableBTNode right,
			int yPos) {
			super();
