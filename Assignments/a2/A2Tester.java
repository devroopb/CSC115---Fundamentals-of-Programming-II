...
public class A2Tester
{
	...
	public static void testOne ()
	{
		...
		System.out.println("Basic testing of size, insertFirst, insertBack, get");
	...
	public static void addArray (int[] a, IntegerList l, boolean insertLast)
	{
	...
	public static void testTwo()
	{
		...
		System.out.println("Testing toString() and removeAll");
	...
	public static void testThree()
	{
		...
		System.out.println("More insert, remove, get testing");
		for (int i = -10;i <= 10; i++)
		{
			l1.insertFirst(i);
		}
